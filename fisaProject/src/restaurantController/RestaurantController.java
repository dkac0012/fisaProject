...
import restaurantDTO.RestaurantDTO;
import restaurantService.RestaurantService;
...
public class RestaurantController {
	...
	// 식당 정보 업데이트 요청 처리
	public void updateRestaurant(String name, String newType, String newMenu1, int newPrice1, String newMenu2,
			int newPrice2) {
		try {
